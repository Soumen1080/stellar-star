...
import { AlertCircle, XCircle, RefreshCw, ArrowLeft, ChevronDown, ChevronUp, ShieldAlert } from "lucide-react";
...
export default function ErrorBoundary({
  ...
  useEffect(() => {
    // Report the error to the maintainer's server endpoint
    reportError("ErrorBoundary.RenderCrash", error, {
      digest: error.digest,
  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6] flex flex-col items-center justify-center px-4 py-12 text-center">
      <div className="max-w-md w-full bg-white border border-[#E5E5E5] rounded-3xl p-6 sm:p-8 shadow-[0_8px_32px_rgba(0,0,0,0.04)]">
        {/* Error icon */}
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
          ...
          <Link
            href="/dashboard"
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-[#E5E5E5] bg-white text-[#555] text-sm font-semibold hover:bg-[#F9F9F9] transition-all"
          >
            <ArrowLeft size={14} />
            Dashboard
          </Link>
